        ...
        <HeaderContainer>
            <Box display={"flex"} gap={3}>
                ...
                <HeaderMenuContainer>
                    ...
                    <HeaderMenuButton onClick={() => navigate("/cities")}>Cities</HeaderMenuButton>
                </HeaderMenuContainer>
            </Box>
            <HeaderIconBox>
                ...
                {isLogin ? (
                    <LogoutIcon sx={{ color: "white" }} cursor={"pointer"} onClick={handleLogout} />
                ) : (
                    <LoginIcon
                        fontSize="small"
                        sx={{ color: "white" }}
            ...
            <MenuDrawer anchor="right" open={open} onClick={toggleDrawer(false)}>
                ...
                >
                    <DrawerTitle onClick={() => handleNavigation("/")}>Travel Now</DrawerTitle>
                ...
                <Box sx={{ display: "flex", flexDirection: "column", gap: 1 }}>
                    <MobileDrawerButton disableRipple fullWidth onClick={() => handleNavigation("/")}>
                        Home
                    </MobileDrawerButton>
                    <MobileDrawerButton disableRipple fullWidth onClick={() => handleNavigation("/cities")}>
                        Cities
                    </MobileDrawerButton>
                </Box>
            </MenuDrawer>
